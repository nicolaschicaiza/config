...
export PATH="$PATH:$MY_LOCAL_HOME/bin:$IDF_PATH/tools/:$IDF_PATH:$IDF_TOOLS:$LATEX_ENV:$XPDFR_HOME:$CHATGPT_HOME:$MY_CUSTOM_BASH:$TERMPDF_HOME:$IDEA_HOME/bin:$KITTY_HOME/bin:$BUN_INSTALL/bin:$DETA_HOME/bin"
...
# OpenAI API key
export OPENAI_API_KEY="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"
export PYENV_ROOT="$HOME/.pyenv"
...
export PATH="$PATH:$ARUINO_HOME/bin"
